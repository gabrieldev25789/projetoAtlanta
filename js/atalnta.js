...
// Define a condição para telas com no máximo 425px
const isMobile = window.matchMedia("(max-width: 425px)");

// Função para ativar os eventos apenas se for mobile
function setupMobileEvents() {
    if (isMobile.matches) {
        traduzir.classList.remove("hide");
        traduzir.textContent = "TRANSLATE TO PORTUGUESE"
...
<br>Grizzy com a pegada das ruas de Atlanta que também traz uma vibe melódica, sombria e versatil pro som, BigXthaPlug com uma pegada mais pesada e crua e Young Thug com sua versatilidade e facilidade de " deslizar " em beats trap faz com que a expectativa pra esse som fique nas alturas.`;
        ...
        traduzir2.textContent = "TRANSLATE TO PORTUGUESE"
        ...
        // Opcional: esconder os botões em telas maiores
...
// Executa também quando a tela for redimensionada
isMobile.addEventListener("change", setupMobileEvents);
